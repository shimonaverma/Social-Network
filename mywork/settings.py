...
SECRET_KEY = 'sxhro&6ir&yt^9m0u$_*)+pwhir8wha8qe!oc5hil&x9&w6iv!'
...
MIDDLEWARE = [
    ...
    'mywork.middleware.LoginRequiredMiddleware',
]
...
LOGIN_EXEMPT_URLS = (
    ...
    r'^app/reset-password/confirm/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
